...
# bootstrap uses class danger for error messages
...
SECRET_KEY = os.environ.get('SECRET_KEY_DJANGO_WEB_SHOP')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME_WEB_SHOP_APP'),
...
LOGOUT_REDIRECT_URL = 'shop_index'
